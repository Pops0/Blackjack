...
def dealer():
  ...
  if dealer_score < 17:
    ...
    print(f"The dealer STANDS, their hand consisting of:{dealer_hand}. Their score of {dealer_score}.")
    dealer_stand = True
    checkWinner()
...
def ask():
  ...
  if query == 'hit':
    ...
    if round == 1:
      ...
      dealer()
      print(f"The dealer's hand currently consists of:{dealer_hand}. Their score total is {dealer_score}.")
      checkWinner()
    elif round == 2:
